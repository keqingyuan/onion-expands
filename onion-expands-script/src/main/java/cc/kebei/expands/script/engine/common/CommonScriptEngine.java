...
public abstract class CommonScriptEngine extends ListenerSupportEngine {
    ...
    @Override
    public cc.kebei.expands.script.engine.ScriptContext getContext(String id) {
    ...
    protected class CommonScriptContext extends cc.kebei.expands.script.engine.ScriptContext {
